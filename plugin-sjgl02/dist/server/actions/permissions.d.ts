...
export declare function savePermissions(ctx: Context, next: Next): Promise<void>;
export declare function getSettings(ctx: Context, next: Next): Promise<void>;
export declare function saveSettings(ctx: Context, next: Next): Promise<void>;
