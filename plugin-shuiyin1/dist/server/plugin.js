...
class PluginShuiyin1Server extends import_server.Plugin {
  ...
  async syncVersion() {
    ...
    try {
      ...
      this.app.log.debug("[shuiyin1] syncVersion", { packageName, version: pkg == null ? void 0 : pkg.version });
      ...
      this.app.log.error(`[shuiyin1] syncVersion error: ${err == null ? void 0 : err.message}`);
    }
  }
  readPackageJson() {
    const candidates = [
